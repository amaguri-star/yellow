<div class="h-screen w-64 min-w-max">
    ...
    <nav>
        <div>
            <a class="flex items-center mt-5 py-2 px-8 text-gray-600 border-r-4 border-white hover:bg-gray-200 hover:text-gray-700 hover:border-gray-700 transition ease-in-out duration-200"
                href="{{ route('home') }}">
            ...
            <div
                class="flex items-center mt-5 py-2 px-8 text-gray-600 border-r-4 border-white hover:bg-gray-200 hover:text-gray-700 hover:border-gray-700 transition ease-in-out duration-200">
